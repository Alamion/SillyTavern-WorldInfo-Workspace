...
| A16 | Context scope and trim | Scope = whole workspace on a 300-entry workspace (import a large book), context limit 8000 | Request succeeds within limit; notice lists omitted parts; only in-scope handles accepted as targets |
